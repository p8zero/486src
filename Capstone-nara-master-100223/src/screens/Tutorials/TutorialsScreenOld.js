    ...
    return (
        ...
        style={styles.safeAreaView}>
            ...
            <TouchableOpacity
                ...
                <TouchableOpacity
                    onPress={() => {navigation.navigate('CreatingAPersonaVideoScreen'); mixpanel.track('Creating Characters');}}
                    style={styles.touchableOpacity}>
                    <Text style={styles.opacityText}>
                        Creating Characters
                    </Text>
                ...
                <TouchableOpacity
                    onPress={() => {navigation.navigate('CreatingANarrativeVideoScreen'); mixpanel.track('Creating Stories');}}
                    style={styles.touchableOpacity}>
                <Text style={styles.opacityText}>
                        Creating Stories
                    </Text>
