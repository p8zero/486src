...
const EditNarrativesTutorial = ({navigation}) => {
    ...
    <Text style = {{
        ...
        <Text style = {{
           ...
           And if you still want to write your story down, we've got a notes page that you can access after you've completed the story building process.
        </Text>
...
<View style={{
    ...
    <Text style = {{
        ...
        <Text style = {{
           ...
           Creating a story with the plot points is simple. Read through the different categories and select the ones that are relevant to the story.
        </Text>
        <Text style = {{
            color: '#000000',
            fontFamily: 'WorkSans-Light',
        ...
        <Text style = {{
            ...
            If you want to see the details of a plot point, scroll down and click "View"
        </Text>
                <Text style = {{
            color: '#000000',
            fontFamily: 'WorkSans-Light',
            ...
            Once you've added all the plot points you want, scroll down and click "Done".
        </Text>
    ...
    <YoutubePlayer
                ...
                play={playing}
                mute={isMute}
                videoId={'6wUTRcQhmvs?feature=share'}
...
<View style={{
    ...
    <Text style = {{
        ...
        <Text style = {{
          ...
          If you selected a story theme, there will be plot points that have been pre-selected.
        </Text>
        <Text style = {{
            color: '#000000',
            fontFamily: 'WorkSans-Light',
            ...
            You can unselect these and select other plot points as you wish.
        </Text>    
...
export default EditNarrativesTutorial;
