...
export default SimilarityWithStory = ({id, matchedDocument, matchedUserDetails, thisNarrative, narrativeDetails}) =>{

    const [story, setStory] = useState(generateDescription({
        inputData: narrativeDetails.data,
    ...
    const [thisStory, setThisStory] = useState(generateDescription({
        inputData: thisNarrative.data,
    ...
    useEffect(() => {
        setSimilarityHandler(findSimilarities(story, thisStory));
    }, [story, thisStory])
        ...
        return(
            <View style={styles.main_container}>
                ...
                <View style={styles.textContainer}>
                    <Text style={styles.text}>Story Similarity With {narrativeDetails.mainChar}</Text>
                </View>
