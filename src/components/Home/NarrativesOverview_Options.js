...
const NarrativesOverview_Options = ({Deduction, Edit, Duplicate, Delete,id, data, notes, name}) => {
  ...
  const SelectedTab = () => {
    switch (selectedTab) {
      ...
      case 'b':
        return <NarrativesOptionsTab Deduction={Deduction}  Edit={Edit} Duplicate={Duplicate} Delete={Delete}/>;
      default:
        return <NarrativesOverviewTab PersonName={name} data={data}/>;
    }
  };
