  ...
  return (
    ...
    >
      ...
      <View style={{}}>
        ...
        >
          What emotions is {mainChar} showing in this story?
        </Text>
      </View>

      <View style={{ borderWidth: 0.5, borderColor: "#FFF5EF" }}></View>
      ...
      <ScrollView>
        ...
        >
          <Text style={styles.headertext}>Positive</Text>
        </View>
        ...
        >
          ...
          >
            <Text style={styles.text}>Excitement</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={
          ...
          >
            <Text style={styles.text}>Joy</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={
          ...
          >
            <Text style={styles.text}>Calmness</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={
          ...
          >
            <Text style={styles.text}>Serenity</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={
        ...
        >
          <Text style={styles.headertext}>Negative</Text>
        </View>
        ...
        >
          ...
          >
            <Text style={styles.text}>Irritation</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={
          ...
          >
            <Text style={styles.text}>Annoyance</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={
          ...
          >
            <Text style={styles.text}>Embarassment</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={
          ...
          >
            <Text style={styles.text}>Helplessness</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={
          ...
          >
            <Text style={styles.text}>Worry</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={
          ...
          >
            <Text style={styles.text}>Frustration</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={
          ...
          >
            <Text style={styles.text}>Guilt</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={
          ...
          >
            <Text style={styles.text}>Shame</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={
          ...
          >
            <Text style={styles.text}>Boredom</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={
          ...
          >
            <Text style={styles.text}>Despair</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={
          ...
          >
            <Text style={styles.text}>Disappointment</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={
          ...
          <TouchableOpacity
            style={
              negativeAndPassive[4] == 1 ? styles.buttonSelected : styles.button
            }
            onPress={() => updateNegativeAndPassive(4)}
          >
            <Text style={styles.text}>Sadness</Text>
          </TouchableOpacity>
          <TouchableOpacity
