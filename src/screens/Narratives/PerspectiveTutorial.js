...
const PerspectiveTutorial = ({navigation}) => {
    ...
    <Text style = {{
        ...
        <Text style = {{
           ...
           You may feel that writing a story from a singular point of view will be biased, but that's actually the point.
        </Text>
        <Text style = {{
            color: '#000000',
            fontFamily: 'WorkSans-Light',
...
It's to help get a complete, clear idea what the narrator is likely feeling and thinking in the moment.
        </Text>
        <Text style = {{
            color: '#000000',
            fontFamily: 'WorkSans-Light',
