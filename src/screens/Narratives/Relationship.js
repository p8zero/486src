    ...
    <SafeAreaView
      ...
      <ScrollView>
        ...
        <View style={{ flexWrap: 'wrap', flexDirection: 'row', marginHorizontal: '4%' }}>
          ...
          <TouchableOpacity style={relationship == relations.SIGNIFICANT_OTHER ? styles.buttonSelected2 : styles.button2} onPress={() => setRelationship(relations.SIGNIFICANT_OTHER)}>
            <Text style={styles.text}>
              Significant Other
            </Text>
          </TouchableOpacity>
