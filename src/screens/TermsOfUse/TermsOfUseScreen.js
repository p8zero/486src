...
const TermsOfUse = ({navigation}) => {
    return (
        ...
        <Text style={{fontFamily: 'WorkSans-Light', fontWeight: '400', fontSize: 24,  color: '#000000'}}>
                      Naralytics Terms of Use
                      </Text>
                      <Text style={{fontFamily: 'WorkSans-Light', fontWeight: '400', fontSize: 18,  color: '#000000', marginTop: '2%'}}>
                      (Effective as of 5/5/2023)
                      </Text>
                      <Text style={{fontFamily: 'WorkSans-Light', fontWeight: '300', fontSize: 16,  color: '#000000', marginTop: '5%'}}>
                      ...
                      <Text style={{fontFamily: 'WorkSans-Light', fontWeight: '300', fontSize: 16,  color: '#000000', marginTop: '2%'}}>
                      ...
                      <Text style={{fontFamily: 'WorkSans-Light', fontWeight: '400', fontSize: 20,  color: '#000000', marginTop: '5%'}}>
                      PRIVACY POLICY
                      </Text>
                      <Text style={{fontFamily: 'WorkSans-Light', fontWeight: '300', fontSize: 16,  color: '#000000', marginTop: '2%'}}>
...
If you are a California resident using the Service, you may specifically waive California Civil Code §1542, which says: “A general release does not extend to claims which the creditor does not know or suspect to exist in his favor at the time of executing the release, which if known by him must have materially affected his settlement with the debtor.”
                      ...
                      <Text style={{fontFamily: 'WorkSans-Light', fontWeight: '300', fontSize: 16,  color: '#000000', marginTop: '2%', marginBottom: '10%'}}>
