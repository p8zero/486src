  ...
  const { user } = useContext(AuthContextNew)
   ...
   // this was reused from the EditUserNameScreen.js file in the Account folder
    ...
    <SafeAreaView style={ styles.SubscribedScreen } >
        ...
        <Text style={{fontFamily: 'WorkSans-light', fontSize: 24, fontWeight:'300',  letterSpacing: 2, color: '#000000'}}>
            Your Subscription
        </Text>
      </View> 
        ...
        <View style={{}}>
            ...
            <View style={ styles.SubscriptionTextView} >
                ...
                <Text style={ styles.AutoRenew}>To manage your subscription, click the "Manage Subscription" button. It will take you to the App Store or Google Play Store on your mobile device where you can renew or cancel your subscription.</Text>
            </View>
