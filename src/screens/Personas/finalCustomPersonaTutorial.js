...
const FinalCustomPersonaTutorial = ({navigation}) => {
    ...
    <Text style = {{
            ...
            fontSize: 20,
            marginLeft: '3%'
        }}>Reading the Character Description
        </Text>
        </View>
        <Text style = {{
            color: '#000000',
            ...
            The character description is a representation of a person's personality & values.
        </Text>
        <Text style = {{
            color: '#000000',
            fontFamily: 'WorkSans-Light',
        ...
        <Text style = {{
            ...
            To that end, the description is organized into specific, unique categories that will help you to clearly understand each part of the description.
        </Text>
        ...
        <Text style = {{
            ...
            Once you're done reading the description, scroll down and select "Done" and the character description will be stored on the "Characters You've Creates" page for you to access whenever you need.
        </Text>
    ...
    <Text style = {{
        ...
        <Text style = {{
            ...
            If you want to personalize this character description, there is a notes page that you use when you select the character on the "Characters You've Created" page and go to the "Options" menu.
        </Text>
