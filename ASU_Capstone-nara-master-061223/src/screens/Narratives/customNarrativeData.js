const clarInTheMom_BehavMastFeatList = [
    {
        ...
        data: [
            {
                ...
                view: [
                    ...
                    `${mainChar} betrayed ${otherChar}'s trust`,
            ...
            },
            {
                ...
                selected: false,
                view: [
                    `${otherChar} betrayed ${mainChar}'s trust`,
            ...
            },
            {
                ...
                description: `A sense of uncomfortableness fills ${otherChar} because ${mainChar} is pushing against or crossing the line.`,
                isClicked: false,
                selected: false,
                view: [
                    ...
                    `${mainChar} is behaving in a way that ${otherChar} finds uncomfortable, rude or inappropriate`,
            ...
            },
            {
                ...
                description: `A sense of uncomfortableness fills ${mainChar} because ${otherChar} is pushing against or crossing the line.`,
                isClicked: false,
                selected: false,
                view: [
                    ...
                    `${otherChar} is behaving in a way that ${mainChar} finds uncomfortable, rude or inappropriate`,
            ...
            {
                id: '9',
                narrativeComponent: `${mainChar} is being hostile towards ${otherChar}`,
                description: `Feelings of hostility consume ${mainChar} when thinking about or being around ${otherChar}.`,
                isClicked: false,
                selected: false,
                view: [
                    `${mainChar} insulted and offended ${otherChar}`,
            ...
            {
                id: '10',
                narrativeComponent: `${otherChar} is being hostile towards ${mainChar}`,
                description: `Feelings of hostility consume ${otherChar} when thinking about or being around ${mainChar}.`,
                isClicked: false,
                selected: false,
                view: [
                    `${otherChar} insulted and offended ${mainChar}`,
        ...
        data: [
            {
                ...
                description: `It's clear in ${otherChar}'s mind that ${mainChar} finds them important because ${mainChar} is showing enough attention and consideration.`,
                isClicked: false,
                selected: false,
                view: [
                    ...
                    `${mainChar} respects and upholds ${otherChar}'s needs and preferences`,
            ...
            },
            {
                ...
                description: `It's clear in ${mainChar}'s mind that ${otherChar} finds them important because ${otherChar} is showing enough attention and consideration.`,
                isClicked: false,
                selected: false,
                view: [
                    ...
                    `${otherChar} respects and upholds ${mainChar}'s needs and preferences`,
      ...
      },
      {
        ...
        data: [
            {
                id: '1',
                narrativeComponent: `${mainChar} is working to meet ${otherChar}'s expectations`,
                description: `There are expectations and responsibilities that ${otherChar} has for ${mainChar} and ${mainChar} is working to meet them.`,
                isClicked: false,
                selected: false,
                view: [
                    `${mainChar} is following through on an agreement made with ${otherChar}`,
                    `${mainChar} is respecting the rules that ${otherChar} has set`,
                    ...
                    `${mainChar}'s general attitude and behavior are acceptable to${otherChar}`,
                    ...
                    `${mainChar} is conducting their public behavior in a manner that ${otherChar} expects`,
                    `${mainChar} is respecting the traditions of ${otherChar}'s religion or culture`,
                ],
            },
            {
                id: '2',
                narrativeComponent: `${otherChar} is working to meet ${mainChar}'s expectations`,
                description: `There are expectations and responsibilities that ${mainChar} has for ${otherChar} and ${otherChar} is working to meet them.`,
                isClicked: false,
                selected: false,
                view: [
                    `${otherChar} is following through on an agreement made with ${mainChar}`,
                    `${otherChar} is respecting the rules that ${mainChar} has set`,
                    ...
                    `${otherChar}'s general attitude and behavior are acceptable to${mainChar}`,
                    `${otherChar} is modeling the very behavior and attitude that is asked of ${mainChar}`,
                    ...
                    `${otherChar} is conducting their public behavior in a manner that ${mainChar} expects`,
                    `${otherChar} is respecting the traditions of ${mainChar}'s religion or culture`,
                ],
            },
            {
                id: '3',
                narrativeComponent: `${mainChar} isn't working to meet ${otherChar}'s expectations`,
                description: `There are expectations and responsibilities that ${otherChar} has for ${mainChar} and ${mainChar} isn't working to meet them.`,
                isClicked: false,
                selected: false,
                view: [
                    `${mainChar} isn't following through on an agreement made with ${otherChar}`,
                    `${mainChar} isn't respecting the rules that ${otherChar} has set`,
                    ...
                    `${mainChar}'s general attitude and behavior are unacceptable to${otherChar}`,
                    `${mainChar} doesn't model the very behavior and attitude that is asked of ${otherChar}`,
                    ...
                    `${mainChar} is conducting their public behavior in a manner that ${otherChar} finds unacceptable`,
                    `${mainChar} doesn't respect the traditions of ${otherChar}'s religion or culture`,
                ],
            },
            {
                id: '4',
                narrativeComponent: `${otherChar} isn't working to meet ${mainChar}'s expectations`,
                description: `There are expectations and responsibilities that ${mainChar} has for ${otherChar} and ${otherChar} isn't isn't working to meet them.`,
                isClicked: false,
                selected: false,
                view: [
                    `${otherChar} isn't following through on an agreement made with ${mainChar}`,
                    `${otherChar} isn't respecting the rules that ${mainChar} has set`,
                    ...
                    `${otherChar}'s general attitude and behavior are unacceptable to${otherChar}`,
                    `${otherChar} doesn't model the very behavior and attitude that is asked of ${mainChar}`,
                    ...
                    `${otherChar} is conducting their public behavior in a manner that ${mainChar} finds unacceptable`,
            ...
            {
                id: '11',
                narrativeComponent: `${mainChar} is focused on their growth`,
                description: `${mainChar} isn't satisfied with staying in their current state and is working to grow.`,
                isClicked: false,
                selected: false,
                view: [
            ...
            {
                id: '12',
                narrativeComponent: `${otherChar} is focused on their growth`,
                description: `${otherChar} isn't satisfied with staying in their current state and is working to grow.`,
                isClicked: false,
                selected: false,
                view: [
            ...
            {
                id: '15',
                narrativeComponent: `${mainChar} does not want to change`,
                description: `${mainChar} has no desire to change their behavior, perspective or beliefs.`,
                isClicked: false,
                selected: false,
                view: [
            ...
            {
                id: '16',
                narrativeComponent: `${otherChar} does not want to change`,
                description: `${otherChar} has no desire to change their behavior, perspective or beliefs.`,
                isClicked: false,
                selected: false,
                view: [
      ...
      },
      {
        ...
        data: [
            {
                id: '1',
                narrativeComponent: `${mainChar} feels able to live freely and independently`,
                description: `In this moment, ${mainChar} feels able to live freely and have the independence to make choices.`,
                isClicked: false,
                selected: false,
                view: [
                    ...
                    `${mainChar} is choosing to meet ${otherChar}'s expectations`,
                    `${mainChar} is choosing to not meet ${otherChar}'s expectations`,
            ...
            {
                id: '2',
                narrativeComponent: `${otherChar} feels able to live freely and independently`,
                description: `In this moment, ${otherChar} feels able to live freely and have the independence to make choices.`,
                isClicked: false,
                selected: false,
                view: [
                    ...
                    `${otherChar} is choosing to meet ${mainChar}'s expectations`,
                    `${otherChar} is choosing to not meet ${mainChar}'s expectations`,
            ...
            {
                id: '3',
                narrativeComponent: `${mainChar} feels unable to live freely and independently`,
                description: `Making choices and living freely is not something ${mainChar} feels able to do in this moment, instead, ${mainChar} feels rather restricted.`,
                isClicked: false,
                selected: false,
                view: [
            ...
            {
                id: '4',
                narrativeComponent: `${otherChar} feels unable to live freely and independently`,
                description: `Making choices and living freely is not something ${otherChar} feels able to do in this moment, instead, ${otherChar} feels rather restricted.`,
                isClicked: false,
                selected: false,
                view: [
      ...
      },
      {
        ...
        data: [
            {
                id: '1',
                narrativeComponent: `${mainChar} doesn't feel better about their relationship with ${otherChar}`,
                description: `Things haven't turned out well with ${otherChar} and it's left ${mainChar} feeling burdened and troubled, even desperate at times.`,
                isClicked: false,
                selected: false,
                view: [
                    `${mainChar} feels less at peace than before`,
                    `${mainChar} feels restricted by ${otherChar}`,
                    `${mainChar} feels disappointed that ${otherChar} doesn't consider their desires`,
                    `${mainChar} feels that their feelings and emotional needs are neglected by ${otherChar}`,
            ...
            {
                id: '2',
                narrativeComponent: `${otherChar} doesn't feel better about their relationship with ${mainChar}`,
                description: `Things haven't turned out well with ${mainChar} and it's left ${otherChar} feeling burdened and troubled, even desperate at times.`,
                isClicked: false,
                selected: false,
                view: [
                    `${otherChar} feels less at peace than before`,
                    `${otherChar} feels restricted by ${otherChar}`,
                    `${otherChar} feels disappointed that ${mainChar} doesn't consider their desires`,
                    `${otherChar} feels that their feelings and emotional needs are neglected by ${mainChar}`,
            ...
            },
            {
                ...
                selected: false,
                view: [
                    `${mainChar} is numbing their mind or body to escape reality`,
            ...
            },
            {
                ...
                selected: false,
                view: [
                    `${otherChar} is numbing their mind or body to escape reality`,
      ...
      },
      {
        ...
        data: [
            {
                id: '1',
                narrativeComponent: `${mainChar} feels better about their relationship with ${otherChar}`,
                description: `Things have turned out well with ${otherChar} and it's given ${mainChar} feelings of peace and joy.`,
                isClicked: false,
                selected: false,
                view: [
                    `${mainChar} feels more at peace than before`,
                    `${mainChar} feels relief and contentment about how things have turned out with ${otherChar}`,
                    `${mainChar} has more hope and excitement about the future of their relationship with ${otherChar}`,
                    `${mainChar} is able to move on from past pain and hurt experienced in their relationship with ${otherChar}`,
                    `${mainChar} is feeling less stressed and overwhelmed by their relationship with ${otherChar}`,
                    `${mainChar} feels loved and paid attention too by ${otherChar}`,
            ...
            {
                id: '2',
                narrativeComponent: `${otherChar} feels better about their relationship with ${mainChar}`,
                description: `Things have turned out well with ${mainChar} and it's given ${otherChar} feelings of peace and joy.`,
                isClicked: false,
                selected: false,
                view: [
                    `${otherChar} feels more at peace than before`,
                    ...
                    `${otherChar} feels loved and paid attention too by ${mainChar}`,
  ...
  const clarInTheFut_SitMastFeatList = [
    {
      ...
      },
      {
        ...
        data: [
            ...
            },
            {
                ...
                selected: false,
                view: [
                    `${mainChar} is jealous of the respect and authority ${otherChar} has and wants to have more than them`,
            ...
            },
            {
                ...
                selected: false,
                view: [
                    `${otherChar} is jealous of the respect and authority ${mainChar} has and wants to have more than them`,
      ...
      },
      {
        ...
        data: [
            ...
            {
                id: '9',
                narrativeComponent: `${mainChar} is motivating ${otherChar} to change`,
                description: `Whether it's a change in behavior and attitude or the pursuit of growth, ${mainChar} is motivating ${otherChar} to see this change through.`,
                isClicked: false,
                selected: false,
                view: [
            ...
            {
                id: '10',
                narrativeComponent: `${otherChar} is motivating ${mainChar} to change`,
                description: `Whether it's a change in behavior and attitude or the pursuit of growth, ${mainChar} is motivating ${otherChar} to see this change through.`,
                isClicked: false,
                selected: false,
                view: [
        ...
        data: [
            {
                ...
                description: `The resources and opportunities ${mainChar} needs to meet the goals, expectations and responsibilities of the moment are accessible.`,
                isClicked: false,
                selected: false,
                view: [
            ...
            },
            {
                ...
                description: `The resources and opportunities ${otherChar} needs to meet the goals, expectations and responsibilities of the moment are accessible.`,
                isClicked: false,
                selected: false,
                view: [
            ...
            },
            {
                ...
                description: `Meeting the goals, expectations and responsibilities of the moment requires the right resources and opportunities and those are not acessible to ${mainChar}.`,
                isClicked: false,
                selected: false,
                view: [
            ...
            },
            {
                ...
                description: `Meeting the goals, expectations and responsibilities of the moment requires the right resources and opportunities and those are not acessible to ${otherChar}.`,
                isClicked: false,
                selected: false,
                view: [
      ...
      },
      {
        ...
        data: [
            {
                id: '1',
                narrativeComponent: `${mainChar} feels insecure around ${otherChar}`,
                description: `A sense of insecurity and lack of trust resides within ${mainChar} when around ${otherChar}.`,
                isClicked: false,
                selected: false,
                view: [
                    ...
                    `${mainChar} has no confidence and self-worth when around ${otherChar}`,
                    `${mainChar} feels like everything is their fault`,
                    `${mainChar} does not feel needed by ${otherChar}`,
                    ...
                    `${mainChar} feels threatened harm by ${otherChar} should the relationship end`,
                    `${mainChar} has a general sense of insecurity within them as life has not gone well up until now`,
                    `${mainChar} does not have a support system that can help them build back their confidence`,
                ],
            },
            {
                id: '2',
                narrativeComponent: `${otherChar} feels insecure around ${mainChar}`,
                description: `A sense of insecurity and lack of trust resides within ${otherChar} when around ${mainChar}.`,
                isClicked: false,
                selected: false,
                view: [
                    ...
                    `${otherChar} has no confidence and self-worth when around ${mainChar}`,
                    `${otherChar} feels like everything is their fault`,
                    `${otherChar} does not feel needed by ${mainChar}`,
                    `${otherChar} feels trapped and restricted by ${mainChar}`,
                    `${mainChar} feels that ${mainChar} has no belief in their abilities`,
                    ...
                    `${mainChar} is feeling unable or afraid to talk about uncomfortable things with ${mainChar}`,
                    `${otherChar} feels that ${mainChar} is unstable and that things could get worse at any time`,
                    `${otherChar} feels threatened harm by ${mainChar} should the relationship end`,
                    `${otherChar} has a general sense of insecurity within them as life has not gone well up until now`,
                    `${otherChar} does not have a support system that can help them build back their confidence`,
                ],
            },
            {
                id: '3',
                narrativeComponent: `${mainChar} is not being treated fairly by ${otherChar}`,
            ...
            {
                id: '4',
                narrativeComponent: `${otherChar} is not being treated fairly by ${mainChar}`,
      ...
      },
      {
        ...
        data: [
            {
                id: '1',
                narrativeComponent: `${mainChar} wants to feel more secure around ${otherChar}`,
                description: `There's a desire within ${mainChar} to feel a greater sense of security and trust in their relationship with ${otherChar}.`,
                isClicked: false,
                selected: false,
                view: [
                    `${mainChar} wants more confidence or self-esteem when around ${otherChar}`,
                    ...
                    `${mainChar} wants to protect their mental and physical well-being from a harmful situation with ${otherChar}`,
                    `${mainChar} wants to know that ${otherChar} is stable and non threatening`,
                    `${mainChar} wants a greater sense of security and stability within their life`,
                    `${mainChar} wants a support system that can help them build back their confidence`,
                    `${mainChar} wants assurance from ${otherChar} that the relationship can end peacefully`,
                    `${mainChar} wants to be able to trust and have confidence in ${otherChar}'s character or abilities`,
                    `${mainChar} wants to feel needed by ${otherChar}`,
            ...
            {
                id: '2',
                narrativeComponent: `${otherChar} wants to feel more secure around ${mainChar}`,
                description: `There's a desire within ${otherChar} to feel a greater sense of security and trust in their relationship with ${mainChar}.`,
                isClicked: false,
                selected: false,
                view: [
                    `${otherChar} wants more confidence or self-esteem when around ${mainChar}`,
                    ...
                    `${otherChar} wants to protect their mental and physical well-being from a harmful situation with ${mainChar}`,
                    `${otherChar} wants to know that ${mainChar} is stable and non threatening`,
                    `${otherChar} wants a greater sense of security and stability within their life`,
                    `${otherChar} wants a support system that can help them build back their confidence`,
                    `${otherChar} wants assurance from ${mainChar} that the relationship can end peacefully`,
                    `${otherChar} wants to be able to trust and have confidence in ${mainChar}'s character or abilities`,
                    `${otherChar} wants to feel needed by ${mainChar}`,
            ...
            {
                id: '4',
                narrativeComponent: `${otherChar} feels secure around ${mainChar}`,
                description: `A sense of security and trust resides within ${otherChar} when around ${mainChar}.`,
                isClicked: false,
                selected: false,
                view: [
                    `${otherChar} is able to trust and have confidence in ${mainChar}'s character or abilities`,
                    `${otherChar} is feeling confident when around ${mainChar}`,
                    `${otherChar} feels needed by ${mainChar}`,
                    `${otherChar} feels that ${mainChar} has belief and confidence in their abilities`,
                    `${otherChar} feels acceptance and support from ${mainChar}`,
                    ...
                    `${otherChar} feels that ${mainChar} is stable and poses no threat to them`,
                    `${otherChar} has assurance from ${mainChar} that the relationship can end peacefully`,
                    `${otherChar} has a general sense of security and stability within them as life has gone well up until now`,
                    `${otherChar} has a support system that helps maintain and build their confidence`,
                ],
            },
            {
                id: '5',
